...
* 처리되지 않은 에셋을 처리하고 `dam:assetState` 다음에 대한 속성 `jcr:content` 자산의 노드를 &quot;처리됨&quot;으로 설정해야 합니다. 또는 AEMaaCS로 마이그레이션하기 전에 마이그레이션 세트에서 이러한 자산을 제거해야 합니다.
