...
>abstract="OAUI 코드는 최소 한 명 이상의 올바른 마이그레이션이 필요한 OAuth 관련 구성된 사용자가 있는 패턴을 식별합니다. rep:AuthorizableId 노드의 바로 아래에 OAuth라는 이름의 하위 노드가 /home/user-path/user-node/oauth의 형식으로 존재하는 경우 사용자에 대해 OAuth가 구성됩니다."
