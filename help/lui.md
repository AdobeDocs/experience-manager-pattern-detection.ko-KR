...
* `translation.dictionary`: /apps 아래에 있는 I18n 사전.
   * 런타임 시 /apps를 변경할 수 없으며 translator.html은 더 이상 AEM as a cloud service에서 사용할 수 없습니다.
...
* 런타임 시 /apps를 변경할 수 없으며 translator.html은 더 이상 AEM as a cloud service에서 사용할 수 없습니다. 따라서 I18n 사전은 CI/CD 파이프라인을 통해 Git에서 가져와야 합니다.
...
* I18n 사전은 CI/CD 파이프라인을 통해 Git에서 가져와야 합니다. [설명서](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/aem-cloud-changes.html?lang=en#apps-libs-immutable)
